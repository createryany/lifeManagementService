...
import com.creater.manageserver.service.base.TblDeptService;
import com.creater.manageserver.mapper.TblDeptMapper;
import org.springframework.stereotype.Service;

/**
* @author creater
* @description 针对表【tbl_dept(部门信息表)】的数据库操作Service实现
* @createDate 2022-08-11 01:58:39
*/
@Service
public class TblDeptServiceImpl extends ServiceImpl<TblDeptMapper, TblDept>
    implements TblDeptService {
