...
public class MyTest {
    ...
    public void testGenerator() {
        ...
        globalConfig.setAuthor("createryan")
                .setOutputDir("C:\\Users\\creater\\Desktop\\yjy\\code\\manage-client\\src\\main\\java\\creater\\management")//设置输出路径
        ...
        dataSourceConfig.setDriverName("com.mysql.cj.jdbc.Driver").setUrl("jdbc:mysql://localhost:3306/yijiayun?serverTimezone=UTC")
                .setUsername("root").setPassword("admin123");
